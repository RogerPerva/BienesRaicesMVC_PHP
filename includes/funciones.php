...
define('CARPETA_IMAGENES', $_SERVER['DOCUMENT_ROOT'] . '/imagenes/'); //definimos la ubicacion de la carpeta de imagenes
define('FORMULARIO_PROPIEDADES', __DIR__.'/templates/formulario_propiedades.php');
define('FORMULARIO_VENDEDORES', __DIR__.'/vendedores/formulario_vendedores.php');
