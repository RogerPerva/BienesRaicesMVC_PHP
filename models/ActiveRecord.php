...
class ActiveRecord{
        ...
        $resultado = self::$db->query($query);
         ...
         //Mensaje de exito o error
            if($resultado){
                ...
                header("Location: ../admin?mensaje=1"); //  lo utilizamos para redireccionar a los usuarios.
    ...
    public function actualizar(){
        ...
        if($resultado){
            //echo "Se ha enviado el formulario";
            //redireccionamos al usuario.
            header("Location: ../admin?mensaje=2"); //  lo utilizamos para redireccionar a los usuarios.
     } 
