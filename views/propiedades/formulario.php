...
<fieldset> <!-- 3!-->
    ...
    <select name="propiedad[vendedorId]" id="vendedor">
        ...
        <?php foreach ($vendedores as $vendedor) : ?>
            <option <?php //Para guardar el vendedor que seleccionamos lo tomamos de $propiedad que es el objeto que estamos llenando.
                    ?> <?php echo $propiedad->vendedorId === $vendedor->id ? 'selected' : '' ?> value="<?php echo s($vendedor->id); ?>">
